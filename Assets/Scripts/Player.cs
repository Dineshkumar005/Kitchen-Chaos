...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    [SerializeField] private Transform kitchenObjecHoldPoint;
    ...
    private void HandleMovement() {
        ...
        if (!canMove) {
            //for movement near the walls diagonally

            //check for movement on X Dir
